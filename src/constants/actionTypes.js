...
//오른쪽 메뉴 - 생일, 결혼기념일, 시스템 공지사항, 워크그룹 공지사항
export const POST_BIRTHDAY = 'POST_BIRTHDAY'
export const POST_BIRTHDAY_SUCCESS = 'POST_BIRTHDAY_SUCCESS'
export const POST_BIRTHDAY_ERROR = 'POST_BIRTHDAY_ERROR'

export const POST_MARRYDAY = 'POST_MARRYDAY'
export const POST_MARRYDAY_SUCCESS = 'POST_MARRYDAY_SUCCESS'
export const POST_MARRYDAY_ERROR = 'POST_MARRYDAY_ERROR'
