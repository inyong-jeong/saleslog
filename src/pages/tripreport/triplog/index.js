...
import { getTripSalesLog, deleteTripSalesLog } from 'redux/tripreport/actions';
import { convertTimeToFormat } from 'helpers/timeUtils';
import TripCouserModal from 'components/TripCouserModal'
...
function TripLog(props) {
  ...
  const loading = props.tripsalesLogLoading;
  const logId = props.match.params.id;
  let body = props.tripSalesLog;
  ...
  const deleteToggleModal = (e) => { e.preventDefault(); setModal(!modal); deleteTripSalesLog(e); };
  ...
  useEffect(() => {
    props.getTripSalesLog(props.match.params.id);
  ...
  useEffect(() => {
    ...
    if (body) {
      ...
      setForm(body.form ? JSON.parse(body.form) : []);
    }
  }, []);
  ...
  const deleteTripSalesLog = () => {
    props.deleteTripSalesLog(logId);
    props.history.push('/main/tripreport');
  ...
  return (
    <React.Fragment>
      ...
      <div className="container" id="saleslog">
        ...
        {(!loading && !props.getSalesLogError) &&
          <div className="container">
            <div className="row">
              <div className="col">
                <div className="page-title-box">
                  <h4 className="page-title">출장보고서 상세</h4>
                </div>
              </div>
            </div>
              ...
              <div className="col">
                <div className="d-flex justify-content-end align-items-center">
                  ...
                  {/* <Select className="form-select form-select-lg" onClick={handleOnClick} placeholder="공동작성자 추가"
                                ...
                                menuColor='red'
                                /> */}
                  <TripCouserModal buttonLabel='공동작성자 추가' />
                </div>
              </div>
            </div>
                  ...
                  <div className="card mr-2 d-inline">
                    <div className="card-body">
                      <div className="row">
                        ...
                        <div className="col-lg-8 col-sm-12 col-xs-12">
                          <p>작성일</p>
                          <h5>{convertTimeToFormat(body.trip_date)}</h5>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12 col-md-pull-12">
                <div className="row">
                  ...
                  <div className="col-12">
                    <Card title="현황" children={form.present_report}>

                    </Card>
                  </div>
                  <div className="col-12">
                    <Card title="향후진행내용" children={form.post_report}>

                    </Card>
                  </div>
                  <div className="col-12" >
                    <Card title="시사점-니즈 " children={form.implication_needs}>

                    </Card>
                  </div>
                  <div className="col-12">
                    <Card title="시사점-전략" children={form.implication_strategy}>
...
const mapStateToProps = (state) => {
  ...
  const { tripSalesLog, tripsalesLogLoading } = state.TripReport
  return { salesLogLoading, salesLog, postFileUrl, postFileResponse, comments, deleteSalesLogResponse, postCommentsResponse, salesLogError, user, fileGetResponse, fileName, uploadDone, salesLogList, userList, putSalesLogGuideResponse, deleteSalesLogGuideResponse, tripSalesLog, tripsalesLogLoading };
};
...
const mapStateToDispatch = {
  ...
  getTripSalesLog: getTripSalesLog.call,
  deleteTripSalesLog: deleteTripSalesLog.call
}


export default connect(mapStateToProps, mapStateToDispatch)(TripLog);