        ...
        <div className="col-12">
          <table className="table sl-table">
            ...
            <tbody>
              ...
              {props.searchsalesLogList && props.searchsalesLogList.map((v, i) => {
                return (
...
const mapStateToProps = (state) => {
  const { salesLogList, salesLogListError, searchsalesLogList } = state.SalesLog;
  return { salesLogList, salesLogListError, searchsalesLogList };
}


export default withRouter(connect(mapStateToProps, {})(SearchTable));